...
export async function generateMetadata({
  ...
  return {
    title: `Best ${category.name} in Utah — ${year} Rankings | FoodMedals`,
    description: `Community-voted ${category.name} rankings across Utah restaurants. See who holds Gold, Silver & Bronze for ${year}.`,
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            {[currentYear - 1, currentYear].map(y => (
              <Link
                key={y}
                href={`/categories/${slug}${y !== currentYear ? `?year=${y}` : ''}`}
