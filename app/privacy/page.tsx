        ...
        <div className="bg-white rounded-2xl border border-amber-100 shadow-sm p-6 sm:p-8 space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              ...
              <li><strong>Google Maps Geocoding:</strong> Used to geocode restaurant addresses (convert addresses to map coordinates). When a restaurant is added, its address is sent to Google&apos;s Geocoding API. <Link href="https://policies.google.com/privacy" className="text-yellow-700 hover:underline" target="_blank" rel="noopener noreferrer">Google Privacy Policy</Link></li>
              <li><strong>OpenStreetMap:</strong> Used to display map tiles on restaurant and profile pages. <Link href="https://osmfoundation.org/wiki/Privacy_Policy" className="text-yellow-700 hover:underline" target="_blank" rel="noopener noreferrer">OpenStreetMap Privacy Policy</Link></li>
            </ul>
            <p className="mt-2">
